...
using part1_2_direct_classify.py as base code on new dataset
...
dataset = load_dataset("reshabhs/SPML_Chatbot_Prompt_Injection") # only has train dataset
# split into train and test
dataset = dataset["train"].train_test_split(test_size=0.2, seed=SEED) # 80-20 split

# combine System Prompt and User Prompt into single text field
...
name = "part2_1_deberta_prompt_injections_metrics.csv"
df_metrics.to_csv(name, index=False)
print(f"Metrics saved to {name}")

print(df_metrics)

model_save_path = "part2_1_deberta_prompt_injection_model"
