"""
Part 1_2: Direct Prompt Injection Classification
...
second iteration of part 1 with hyperparameter tuning:
    - increased epochs from 1 to 3
    - changed batch size from 16 to 32
"""
import random
...
name = "part1_2_deberta_prompt_injections_metrics.csv"
df_metrics.to_csv(name, index=False)
print(f"Metrics saved to {name}")

print(df_metrics)

model_save_path = "part1_2_deberta_prompt_injection_model"
